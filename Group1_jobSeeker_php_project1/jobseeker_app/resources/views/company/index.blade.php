...
<div class="container">
<a href='/company/create'  type="button" class="btn btn-primary" >New Company</a><br>
<div
    ...
    >
        ...
        @foreach ($company_objects as $company)
            ...
            <tr class="">
              ...
              <td><a   href='/company_jobs/{{$company->company_id}}' type="button" class="btn btn-primary">Available jobs</a></td>  
            <td><a href='/company/{{ $company->company_id }}'>Edit</a></td>
                <td>
